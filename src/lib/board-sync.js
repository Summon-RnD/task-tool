import { CLIENTS, DOMAIN_RULES, HARDWARE_VOCAB, PEOPLE, TODAY } from "../data/constants.js?v=39bf532";
import { todayLocalIso } from "./date-core.js?v=39bf532";
import { flat, normalizeTaskTree } from "./tree.js?v=39bf532";
