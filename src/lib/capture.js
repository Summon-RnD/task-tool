import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=ef9f044";
import { todayLocalIso } from "./date-core.js?v=ef9f044";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=ef9f044";
