import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=aab3a35";
import { todayLocalIso } from "./date-core.js?v=aab3a35";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=aab3a35";
