import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=3ec08df";
import { todayLocalIso } from "./date-core.js?v=3ec08df";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=3ec08df";
