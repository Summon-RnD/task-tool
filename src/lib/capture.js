import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=0c79d39";
import { todayLocalIso } from "./date-core.js?v=0c79d39";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=0c79d39";
