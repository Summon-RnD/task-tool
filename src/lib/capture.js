import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=e7306b7";
import { todayLocalIso } from "./date-core.js?v=e7306b7";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=e7306b7";
