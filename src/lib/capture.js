import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=6dc7c74";
import { todayLocalIso } from "./date-core.js?v=6dc7c74";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=6dc7c74";
