import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=307d28d";
import { todayLocalIso } from "./date-core.js?v=307d28d";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=307d28d";
