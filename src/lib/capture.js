import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=16f328e";
import { todayLocalIso } from "./date-core.js?v=16f328e";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=16f328e";
