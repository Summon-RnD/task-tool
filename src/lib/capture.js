import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=58c2c6e";
import { todayLocalIso } from "./date-core.js?v=58c2c6e";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=58c2c6e";
