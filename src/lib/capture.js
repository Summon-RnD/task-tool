import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=aa6139c";
import { todayLocalIso } from "./date-core.js?v=aa6139c";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=aa6139c";
