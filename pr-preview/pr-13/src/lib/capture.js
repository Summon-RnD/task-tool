import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=d3ce510";
import { todayLocalIso } from "./date-core.js?v=d3ce510";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=d3ce510";
