import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=abdc91f";
import { todayLocalIso } from "./date-core.js?v=abdc91f";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=abdc91f";
