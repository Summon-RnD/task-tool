import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=51bb477";
import { todayLocalIso } from "./date-core.js?v=51bb477";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=51bb477";
