import { CLIENTS, DOMAIN_RULES, HARDWARE_VOCAB, PEOPLE, TODAY } from "../data/constants.js?v=becbcb8";
import { todayLocalIso } from "./date-core.js?v=becbcb8";
import { flat, normalizeTaskTree } from "./tree.js?v=becbcb8";
