...
} from "../data/constants.js?v=63fd116";
import { inferOwnerByDomain, canonHardware, findClient, buildRespMapText, buildVocabText, norm as _norm } from "../lib/domain.js?v=63fd116";
import {
...
} from "../lib/tree.js?v=63fd116";
import { createDateHelpers } from "../lib/dates.js?v=63fd116";
import { calendarToday, parseLocalIso, todayLocalIso } from "../lib/date-core.js?v=63fd116";
import {
  cap1, stripCaptions, findOwnerId, findDue, findSize,
  normalizeProposal, mockTranscript, isoCap,
} from "../lib/capture.js?v=63fd116";
import { startBoardSync } from "../lib/board-sync.js?v=63fd116";
import { buildSampleTasks } from "../data/sample-tasks.js?v=63fd116";
