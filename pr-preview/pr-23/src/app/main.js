...
} from "../data/constants.js?v=006c6c6";
import { inferOwnerByDomain, canonHardware, findClient, buildRespMapText, buildVocabText, norm as _norm } from "../lib/domain.js?v=006c6c6";
import {
...
} from "../lib/tree.js?v=006c6c6";
import { createDateHelpers } from "../lib/dates.js?v=006c6c6";
import { calendarToday, parseLocalIso, todayLocalIso } from "../lib/date-core.js?v=006c6c6";
import {
  cap1, stripCaptions, findOwnerId, findDue, findSize,
  normalizeProposal, mockTranscript, isoCap,
} from "../lib/capture.js?v=006c6c6";
import { startBoardSync } from "../lib/board-sync.js?v=006c6c6";
import { buildSampleTasks } from "../data/sample-tasks.js?v=006c6c6";
