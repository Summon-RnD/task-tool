import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=df1f394";
import { todayLocalIso } from "./date-core.js?v=df1f394";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=df1f394";
