import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=3ef72b7";
import { todayLocalIso } from "./date-core.js?v=3ef72b7";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=3ef72b7";
