...
} from "../data/constants.js?v=981cc15";
import { inferOwnerByDomain, canonHardware, findClient, buildRespMapText, buildVocabText, norm as _norm } from "../lib/domain.js?v=981cc15";
import {
...
} from "../lib/tree.js?v=981cc15";
import { createDateHelpers } from "../lib/dates.js?v=981cc15";
import { calendarToday, parseLocalIso, todayLocalIso } from "../lib/date-core.js?v=981cc15";
import {
  cap1, stripCaptions, findOwnerId, findDue, findSize,
  normalizeProposal, mockTranscript, isoCap,
} from "../lib/capture.js?v=981cc15";
import { startBoardSync } from "../lib/board-sync.js?v=981cc15";
import { buildSampleTasks } from "../data/sample-tasks.js?v=981cc15";
...
function openDetail(id,opts){
  ...
  if(opts?.reveal) revealDetailScroll(document.querySelector(".tbox"),opts.reveal);
}
