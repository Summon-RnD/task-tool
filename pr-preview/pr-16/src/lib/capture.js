import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=8d36f2d";
import { todayLocalIso } from "./date-core.js?v=8d36f2d";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=8d36f2d";
