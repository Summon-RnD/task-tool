import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=2daf17e";
import { todayLocalIso } from "./date-core.js?v=2daf17e";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=2daf17e";
