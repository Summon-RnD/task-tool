import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=09b09da";
import { todayLocalIso } from "./date-core.js?v=09b09da";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=09b09da";
