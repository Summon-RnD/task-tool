import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=58a07bf";
import { todayLocalIso } from "./date-core.js?v=58a07bf";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=58a07bf";
