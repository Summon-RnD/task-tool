import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=a8c89ea";
import { todayLocalIso } from "./date-core.js?v=a8c89ea";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=a8c89ea";
