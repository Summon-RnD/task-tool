import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=154e35a";
import { todayLocalIso } from "./date-core.js?v=154e35a";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=154e35a";
