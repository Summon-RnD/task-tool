import { CLIENTS, PEOPLE, TODAY } from "../data/constants.js?v=ac0d273";
import { todayLocalIso } from "./date-core.js?v=ac0d273";
import { canonHardware, findClient, inferOwnerByDomain, norm } from "./domain.js?v=ac0d273";
